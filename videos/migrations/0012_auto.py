...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding index on 'Video', fields ['last_converted']
        db.create_index('videos_video', ['last_converted'])


    def backwards(self, orm):
        
        # Removing index on 'Video', fields ['last_converted']
        db.delete_index('videos_video', ['last_converted'])
