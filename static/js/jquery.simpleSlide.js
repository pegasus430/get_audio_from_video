...
//	
//	<div class="slider_lb" rel="group_name"></div>
//	<div class="slider_rb" rel="group_name"></div>
...
function ssInit(){
	...
	jQuery(function($) {
		...
		/* Actuates upon the clicking of a left- or slider_rb classed element */
		$('.slider_lb, .slider_rb, .jump-to').live('click', function() {
...
function simpleSwipe(this_window) {
	...
	var defaults = {
		...
		swipeLeft: function() {
			simpleSlideAction('.slider_rb', $(this_window).attr('rel'));
		},
		swipeRight: function() {
			simpleSlideAction('.slider_lb', $(this_window).attr('rel'));
		},
